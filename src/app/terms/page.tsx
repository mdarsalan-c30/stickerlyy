  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="prose prose-gray">
        ...
        <p>By using Stickerly, you agree to these terms. If you disagree, please do not use the application.</p>
        
        <h2 className="text-xl font-semibold mt-6 mb-3">2. User Generated Content</h2>
